...
local keydownF5=false--colli box（精确查看碰撞盒）
local keydownF6=false--render call（查看渲染函数调用次数）
local keydownF7=false--cheat（金手指）

local keydownF3=false--缓速级别-1（回归正常速度）
local keydownF4=false--缓速级别+1（子弹时间）
